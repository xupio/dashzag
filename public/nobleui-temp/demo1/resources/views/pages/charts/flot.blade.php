...
@push('plugin-scripts')
  ...
  <script src="{{ asset('build/plugins/jquery.flot/jquery.flot.js') }}"></script>
  <script src="{{ asset('build/plugins/jquery.flot/jquery.flot.resize.js') }}"></script>
  <script src="{{ asset('build/plugins/jquery.flot/jquery.flot.pie.js') }}"></script>
  <script src="{{ asset('build/plugins/jquery.flot/jquery.flot.categories.js') }}"></script>
@endpush

@push('custom-scripts')
  @vite(['resources/js/pages/jquery.flot.js'])
@endpush