...
@push('plugin-styles')
  ...
  <link href="{{ asset('build/plugins/animate-css/animate.min.css') }}" rel="stylesheet" />
@endpush
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-secondary">Read the <a href="https://owlcarousel2.github.io/OwlCarousel2/" target="_blank"> Official Owl Carousel 2 Plugin Documentation </a>for a full list of instructions and other options.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="owl-carousel owl-theme owl-basic">
          <div class="item">
            <img src="{{ url('build/images/others/placeholder.jpg') }}" alt="item-image">
          </div>
          <div class="item">
            <img src="{{ url('build/images/others/placeholder.jpg') }}" alt="item-image">
          </div>
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-secondary mb-3">To add mouswheel scrolling just include the fantastic plugin <a href="https://github.com/brandonaaron/jquery-mousewheel" target="_blank">jquery.mousewheel.js</a>.</p>
...
@push('plugin-scripts')
  ...
  <script src="{{ asset('build/plugins/jquery-mousewheel/jquery.mousewheel.js') }}"></script>
@endpush

@push('custom-scripts')
  @vite(['resources/js/pages/owl-carousel.js'])
@endpush