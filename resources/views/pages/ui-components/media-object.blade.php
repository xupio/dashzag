  ...
  <div class="col-xl-10 main-content ps-xl-4 pe-xl-5">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('build/images/others/placeholder.jpg') }}" class="w-100px w-sm-200px me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('build/images/others/placeholder.jpg') }}" class="w-100px w-sm-150px me-3" alt="...">
        <div>
          <h5 class="mb-2">Media heading</h5>
          ...
          <div class="d-flex align-items-start mt-3">
            <a class="me-3" href="#">
              <img src="{{ url('build/images/others/placeholder.jpg') }}" class="w-100px w-sm-150px" alt="...">
            </a>
            <div>
              <h5 class="mb-2">Media heading</h5>
              Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('build/images/others/placeholder.jpg') }}" class="align-self-start w-100px w-sm-150px me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('build/images/others/placeholder.jpg') }}" class="align-self-center w-100px w-sm-150px me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        <img src="{{ url('build/images/others/placeholder.jpg') }}" class="align-self-end w-100px w-sm-150px me-3" alt="...">
        <div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
    ...
    <div class="example">
      <div class="d-flex align-items-start">
        ...
        <img src="{{ url('build/images/others/placeholder.jpg') }}" class="w-100px w-sm-150px ms-3" alt="...">
      </div>
    </div>
