          ...
          <div class="col-lg-9 col-xxl-10">
            <div class="p-3 border-bottom">
              <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                  <form method="GET" action="{{ route('email.drafts') }}" class="input-group">
              ...
              @forelse ($messages as $message)
                <div class="email-list-item">
                  ...
                  <a href="{{ route('email.compose', ['draft' => $message->id]) }}" class="email-list-detail">
                    <div class="content">
                      <span class="from">Draft @if($message->attachments->isNotEmpty()) · {{ $message->attachments->count() }} attachment{{ $message->attachments->count() === 1 ? '' : 's' }} @endif</span>
