      ...
      <div class="card-body">
        <div class="container-fluid d-flex justify-content-between">
          ...
          <div class="col-lg-3 pe-0">
            ...
            <h6 class="mb-0 mt-3 text-end fw-normal mb-2"><span class="text-secondary">Invoice Date :</span> 25rd Jan 2026</h6>
            <h6 class="text-end fw-normal"><span class="text-secondary">Due Date :</span> 12th Jul 2026</h6>
          </div>
        </div>
        ...
        <div class="container-fluid w-100">
          <a href="javascript:;" class="btn btn-primary float-end mt-4 ms-2"><i data-lucide="send" class="me-3 icon-md"></i>Send Invoice</a>
          <a href="javascript:;" class="btn btn-outline-primary float-end mt-4"><i data-lucide="printer" class="me-2 icon-md"></i>Print</a>
        </div>
      </div>
    </div>
  </div>
