        ...
        <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
          <div class="card">
            <div class="card-body">
              ...
              <table class="mx-auto">
                <tr>
                  <td><i data-lucide="check" class="icon-md text-primary me-2"></i></td>
                ...
                <tr>
                  <td><i data-lucide="x" class="icon-md text-danger me-2"></i></td>
                  <td><p class="text-secondary">Branded website</p></td>
                </tr>
                <tr>
                  <td><i data-lucide="x" class="icon-md text-danger me-2"></i></td>
                  <td><p class="text-secondary">Dedicated account manager</p></td>
                </tr>
                <tr>
                  <td><i data-lucide="x" class="icon-md text-danger me-2"></i></td>
                  <td><p class="text-secondary">Premium apps</p></td>
                </tr>
              </table>
              <div class="d-grid">
