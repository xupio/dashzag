...
@push('custom-scripts')
  <script src="{{ asset('build/assets/form-validation-DmnBjH_8.js') }}"></script>
  <script src="{{ asset('build/assets/bootstrap-maxlength-CpLTJAzH.js') }}"></script>
  <script src="{{ asset('build/assets/inputmask-BxljHLGE.js') }}"></script>
  <script src="{{ asset('build/assets/select2-Ck9N6V5Z.js') }}"></script>
  <script src="{{ asset('build/assets/typeahead--T3x3_ze.js') }}"></script>
  <script src="{{ asset('build/assets/tags-input-ConULRuM.js') }}"></script>
  <script src="{{ asset('build/assets/dropzone-BWaORfQZ.js') }}"></script>
  <script src="{{ asset('build/assets/dropify-DXoFLZ5g.js') }}"></script>
